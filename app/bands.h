...
static const bandparameters BParams[32] = {
    // BandName         Startfrequency    Stopfrequency    scanStep          modulationType
    {"20M (14MHz)",    1400000,          1425000,       S_STEP_5_0kHz,    MODULATION_SSB},
    ...
    {"5M(50-54MHz)",   5000000,          5400000,       S_STEP_12_5kHz,   MODULATION_FM},
    ...
    {"VHF(162+MHz)",  16200000,         17000000,       S_STEP_25_0kHz,   MODULATION_FM},
	{"VHF(170+MHz)",  17000000,         17400000,       S_STEP_25_0kHz,   MODULATION_FM},
